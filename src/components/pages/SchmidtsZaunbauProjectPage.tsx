...
const sectionIcons = [ShieldCheck, Smartphone, ShieldCheck] as const;
...
export function SchmidtsZaunbauProjectPage() {
  const { locale } = useLocale();
  const content = getProductShowcaseContent(locale).schmidtsZaunbau;
            ...
            <div className="grid grid-cols-1 gap-10 xl:grid-cols-[0.9fr_1.1fr] xl:items-center">
                ...
                <div>
                  ...
                  <div className="mt-7">
                    <div>
                      ...
                      <p className="mt-3 text-sm font-semibold uppercase tracking-[0.18em] text-ouest/75 sm:text-base">
                        {content.tagline}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="mt-9 flex flex-col gap-4 sm:flex-row sm:flex-wrap">
                    <a
                      href={productLinks.schmidtsZaunbauLive}
                      target="_blank"
              ...
              <RevealOnScroll delayMs={120}>
                <div className="group rounded-[2.3rem] border border-littoral/10 bg-white/70 p-4 shadow-[0_30px_90px_-54px_rgba(26,23,21,0.32)] backdrop-blur-sm">
                  ...
                  <div className="overflow-hidden rounded-[1.6rem] ring-1 ring-littoral/10 bg-gradient-to-br from-white to-savane/30 aspect-[16/10] relative">
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="text-center px-6">
                        <h3 className="font-display text-2xl font-bold text-littoral mb-3">Professioneller Zaunbau nach Maß</h3>
                        <p className="text-sm text-littoral/60 mb-6">Premium Design für ein Leader-Image mit integrierter Lead-Generierung</p>
                        <div className="flex gap-2 justify-center">
                          <div className="px-4 py-2 bg-littoral rounded-full text-white text-xs font-semibold">Kostenloses Angebot</div>
                          <div className="px-4 py-2 border border-littoral/20 rounded-full text-littoral text-xs font-semibold">Unsere Leistungen</div>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            <RevealOnScroll>
              <div className="max-w-3xl mb-8">
                <p className="text-xs font-bold uppercase tracking-[0.2em] text-ouest">Showcase du site</p>
                <p className="mt-4 text-lg leading-8 text-littoral/64">Un design premium épuré qui positionne Schmidts Zaunbau Nord comme leader incontesté de l'artisanat en Allemagne du Nord. Architecture web optimisée pour la conversion directe de visiteurs en prospects qualifiés.</p>
              </div>
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div className="rounded-[2rem] border border-littoral/10 bg-white p-4 shadow-[0_24px_70px_-48px_rgba(26,23,21,0.25)]">
                  <div className="flex items-center gap-2 px-3 pb-3 border-b border-littoral/8">
                    <span className="h-2 w-2 rounded-full bg-ouest" />
                    <span className="h-2 w-2 rounded-full bg-foret" />
                    <span className="h-2 w-2 rounded-full bg-littoral/25" />
                    <span className="ml-auto text-[9px] font-semibold text-littoral/40">Desktop</span>
                  </div>
                  <div className="mt-3 overflow-hidden rounded-xl bg-gradient-to-br from-slate-100 to-slate-50 aspect-video flex items-center justify-center">
                    <div className="text-center px-4">
                      <h3 className="font-display text-lg font-bold text-littoral">Hero avec CTA Premium</h3>
                      <p className="text-xs text-littoral/60 mt-2">Design épuré avec hero image professionnelle et CTAs optimisées</p>
                    </div>
                  </div>
                </div>
                <div className="rounded-[2rem] border border-littoral/10 bg-white p-4 shadow-[0_24px_70px_-48px_rgba(26,23,21,0.25)]">
                  <div className="flex items-center gap-2 px-3 pb-3 border-b border-littoral/8">
                    ...
                    <span className="h-2 w-2 rounded-full bg-foret" />
                    <span className="h-2 w-2 rounded-full bg-littoral/25" />
                    <span className="ml-auto text-[9px] font-semibold text-littoral/40">Mobile</span>
                  </div>
                  <div className="mt-3 overflow-hidden rounded-xl bg-gradient-to-br from-slate-100 to-slate-50 aspect-[9/12] flex items-center justify-center">
                    <div className="text-center px-4">
                      <h3 className="font-display text-base font-bold text-littoral">Mobile-First</h3>
                      <p className="text-xs text-littoral/60 mt-2">Optimisé pour smartphone avec WhatsApp intégré</p>
                    </div>
                  </div>
                </div>
              </div>
