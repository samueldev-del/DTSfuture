...
import { SchmidtsZaunbauNordPreview } from "@/src/components/ui/SchmidtsZaunbauNordPreview";
...
const challengeIcons = [Search, ShieldCheck, Smartphone] as const;
const solutionIcons = [BadgeCheck, Star, MapPin] as const;
const processIcons = [Building2, Workflow, Globe, Rocket] as const;
const stackIcons = [Globe, Smartphone, Search, ArrowRight, ShieldCheck, Rocket] as const;

export function SchmidtsZaunbauNordProjectPage() {
  const { locale } = useLocale();
  const content = getProductShowcaseContent(locale).schmidtszaunbaunord;
              ...
              <RevealOnScroll>
                <div>
                  ...
                  <div className="mt-7 flex items-center gap-4">
                    <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-[1.45rem] border border-ouest/12 bg-littoral p-2 shadow-sm shadow-ouest/10 ring-1 ring-littoral/8">
                  ...
                  <div className="mt-9 flex flex-col gap-4 sm:flex-row sm:flex-wrap">
                    <a
                      href={productLinks.schmidtszaunbauNordLive}
                      target="_blank"
